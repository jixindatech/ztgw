...
RUN set -x \
    ...
    && luarocks install ztgw-0.1-2.rockspec --tree=/usr/local/ztgw/deps \
    && cp -v /usr/local/ztgw/deps/lib/luarocks/rocks-5.1/ztgw/0.1-2/bin/ztgw /usr/bin/ \
